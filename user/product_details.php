			...
			foreach ($_COOKIE['item'] as $name => $value) {
				...
				if ($img1==$values11[0]) {
					...
					while ($row=mysqli_fetch_array($res)) {
						$tb_quantity=$row['product_quantity'];
					}
					if ($tb_quantity<$qty) 
					{
						?>
					...
					else
					{
						...
						setcookie("item[$name]",$img1."__".$nm."__".$price."__".$qty."__".$total,time()+1800);
					}	
				}
			}
			if ($found==0)
					...
					<form  name="form1" action="" method="post">
						<div class="col-sm-7">
							<div class="product-information"><!--/product-information-->
								...
								<span>
									<span>US $<?= $row['product_price'] ?></span>
									<label>Quantity:</label>
									<input type="text" value="<?= $row['product_quantity'] ?>" />
									<button type="submit" name="submit1" class="btn btn-fefault cart">
										<i class="fa fa-shopping-cart"></i>
										Add to cart
									</button>
								</span>
								<p><b>Availability:</b><?= $row['product_quantity'] ?></p>
